...
export interface ContractRegistrationInfo {
...
export class MiniKitContractRegistration {
  private static instance: MiniKitContractRegistration;
  
  private constructor() {}
  
  public static getInstance(): MiniKitContractRegistration {
   ...
   */
  async checkContractRegistration(
    contractAddress: string,
    appId: string = 'app_633eda004e32e457ef84472c6ef7714c'
  ): Promise<ContractRegistrationInfo> {
    try {
      ...
      const registrationInfo: ContractRegistrationInfo = {
        contractAddress,
        chainId: 4801,
        appId,
   ...
   */
  getRegistrationGuidance(contractAddress: string): string[] {
    return [
   ...
   */
  logErrorAnalysis(error: any, contractAddress: string): void {
